...
import { setPinTarget, setDeleteTarget, setHistoryEditTarget, copyHistoryItemToTop, hasPlaceholders, openPlaceholderFill, applyPlaceholders, recordPastedAt } from '../store/clipboard-store';
